...
const { getOneOrder, getAllOrders, deleteOneOrder, acceptOrder,LateOrder, DeliveredOrder, INPROGRESSorder, CancelledOrder } = require('../Controllers/BuyerOrder/BuyerOrder');
